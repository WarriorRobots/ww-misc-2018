...
public class IntakeSubsystem extends Subsystem {
	...
	private WPI_TalonSRX leftPickupMotor, rightPickupMotor, leftBeltMotor, rightBeltMotor, leftShooterMotor, rightShooterMotor;
	private DigitalInput infaredSensor;
	
	public IntakeSubsystem() { // there's not supposed to be a follow command
